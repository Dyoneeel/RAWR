...
// Remove redundant session_start(); already handled in init.php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Replace this with your real authentication logic
    $username = $_POST['username'] ?? '';
    $password = $_POST['password'] ?? '';
    // Example: Dummy check
    if ($username === 'lion' && $password === 'roar') {
        $_SESSION['user'] = $username;
        // Redirect to dashboard (JS also does this, but this is for non-JS fallback)
        header('Location: dashboard.php');
        exit;
    } else {
...
<body>
    ...
    <div class="auth-container">
        <div class="logo-header">
            <div class="lion-emoji" onclick="roarEffect()">🦁</div>
            <h1 class="logo">RAWR</h1>
            <p class="tagline">Join the pride of crypto lions</p>
        </div>
        ...
        <form class="form" id="loginForm" method="post" action="">
            <div class="input-group">
                ...
                <input type="text" name="username" class="input-field" placeholder="Enter your email or username" required>
            </div>

            <div class="input-group">
                <label class="input-label">Password</label>
                <div style="position: relative;">
                    <input type="password" name="password" class="input-field" id="loginPassword" placeholder="Enter your password" required>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            // Let PHP handle the actual login, but show spinner for effect
            setTimeout(() => {
